      ...
      <div className='max-w-6xl mx-auto px-6 py-16'>
        <motion.div
            ...
            <h1 className='text-4xl md:text-5xl font-bold mb-5 leading-tight'>
                Build Websites<span className='block bg-linear-to-r from-white to-zinc-400
        ...
        {/* prompt div */}
        <div className='mb-14'>
            <h1 className='text-xl font-semibold mb-2'>Describle your website</h1>
            <div className='relative'>
                <textarea placeholder='Describe your website in detail...'
                className='w-full h-56 p-6 rounded-3xl bg-black/60 border border-white/10 outline-none
                text-sm leading-relaxed focus:ring-2 focus:ring-white/20'
                value={prompt}
        ...
        <div className='flex justify-center'>
            <motion.button 
                ...
                className={`px-14 py-4 rounded-2xl font-semibold text-lg ${prompt.trim() && 
                    !loading ? "bg-white text-black" : "bg-white/20 text-zinc-400 cursor-not-allowed"}`}>
                Generate Website
            </motion.button>
        </div>
