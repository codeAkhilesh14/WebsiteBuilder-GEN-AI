    ...
    <div className='min-h-screen bg-[#050505] text-white'>
      ...
      <div className='sticky top-0 z-40 backdrop-blur-xl bg-black/50 border-b border-white/10'>
        <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
            ...
            <button className='px-4 py-2 rounded-lg bg-white text-black text-sm font-semibold hover:scale-105 transition cursor-pointer'
            ...
            {websites.map((w, i)=>{
              ...
              >
                <div className='relative h-40 bg-black cursor-pointer'>
                  <iframe srcDoc={w.latestCode} className='absolute inset-0 w-[140%] h-[140%]
                ...
                {!w.deployed ? (
                  <button
                    className='mt-auto flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm cursor-pointer
                    font-semibold bg-linear-to-r from-indigo-500 to-purple-500 hover:scale-105 transition'
                    onClick={(e)=>{
                      e.stopPropagation()
                      handleDeploy(w._id)
                    }}>
                  ...
                  (
                    ...
                    className={`mt-auto flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm
