...
export const generateWebsite = async (req, res) => {
    try {
        ...
        if(user.credits < 50) {
            return res.status(400).json({message: "You donot have enough credits to generate a website"})
        }
        ...
        return res.status(500).json({message: `Error while generating website ${error}`})
    }
}
...
export const changes = async (req, res) => {
    try {
        ...
        return res.status(500).json({message: `Error while updating the website ${error}`})
    }
}
...
export const getAll = async (req, res) => {
    try {
        ...
        return res.status(500).json({message: `Error while getting all websites ${error}`})
    }
}
...
export const deploy = async (req, res) => {
    try {
        ...
        return res.status(500).json({message: `Error while deploying the website ${error}`})
    }
}
